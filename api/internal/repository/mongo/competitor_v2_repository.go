...
// UpdatePricing updates the pricing data for a competitor
func (r *CompetitorV2Repository) UpdatePricing(ctx context.Context, id primitive.ObjectID, userID primitive.ObjectID, pricing *model.CompetitorPricing) error {
	filter := bson.M{
		"_id":     id,
		"user_id": userID,
	}
...
// UpdatePricingVerification marks pricing as verified
func (r *CompetitorV2Repository) UpdatePricingVerification(ctx context.Context, id primitive.ObjectID, userID primitive.ObjectID, verified bool) error {
	filter := bson.M{
		"_id":     id,
		"user_id": userID,
	}
