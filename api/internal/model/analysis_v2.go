...
type PricingPlanInput struct {
	...
	PriceMonthly float64  `json:"price_monthly,omitempty" bson:"price_monthly,omitempty"`
	PriceYearly  float64  `json:"price_yearly,omitempty" bson:"price_yearly,omitempty"`
