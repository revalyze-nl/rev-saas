            ...
            <div className="relative bg-slate-800/50 backdrop-blur-sm rounded-3xl border border-slate-700 p-8 shadow-2xl">
              ...
              <div className="bg-slate-900/50 rounded-2xl p-6 space-y-6">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700 hover:border-blue-500/50 transition-colors text-center">
                    <div className="text-xs text-slate-400 mb-1 font-medium">MRR</div>
                    <div className="text-2xl font-bold text-white">$47.8K</div>
                    <div className="flex items-center justify-center text-xs text-blue-400 mt-1 font-medium">
                  ...
                  <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700 hover:border-blue-500/50 transition-colors text-center">
                    ...
                    <div className="flex items-center justify-center text-xs text-green-400 mt-1 font-medium">
                  ...
                  <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700 hover:border-yellow-500/50 transition-colors text-center">
                    <div className="text-xs text-slate-400 mb-1 font-medium">Position</div>
                    <div className="text-2xl font-bold text-white">Mid</div>
                    <div className="flex items-center justify-center text-xs text-yellow-400 mt-1 font-medium">
                      <svg className="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
